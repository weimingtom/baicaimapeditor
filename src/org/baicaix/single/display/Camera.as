...
package org.baicaix.single.display {
	...
	public class Camera extends EventDispatcher {
		...
		public function Camera(showPixelWidth : int, showPixelHeight : int, cellWidth : int, cellHeight : int, cache : int) {
		...
		public function regester(base : Browser) : void {
			_base = base;

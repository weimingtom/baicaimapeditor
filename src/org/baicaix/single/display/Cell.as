...
package org.baicaix.single.display {
	...
	public class Cell {
		...
		public function Cell(base : Browser, logicX : int, logicY : int, cellWidth: int, cellHeight : int, loader : ResourceImgLoader) {
...
//			_canvasLayer.setPixel32(x, y, color);
		...
		public function drawType() : void {
			if(_tiles[0].type == Tile.DEFAULT_TILE_TYPE) return;

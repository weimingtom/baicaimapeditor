...
package org.baicaix.modules.beans {
	...
	public class Tile {
		...
		public function Tile(parent : Map=null, src : int = -1, srcX : int = -1, srcY : int = -1) {
		...
		public function paste(tile : Tile) : void {
			if(tile == null) return;
			setSource(tile.src, tile.srcX, tile.srcY, tile.type);
			if(_parent != null && _parent.ress != null && _parent.ress.indexOf(tile.src) < 0)
